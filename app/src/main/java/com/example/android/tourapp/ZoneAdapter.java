...
public class ZoneAdapter extends ArrayAdapter<Zone>  {
     ...
     * @param words is the list of {@link Zone}s to be displayed.
     * @param colorResourceId is the resource ID for the background color for this list of zones
     */
    public ZoneAdapter(Context context, ArrayList<Zone> words, int colorResourceId) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView miwokTextView = (TextView) listItemView.findViewById(R.id.name_list);
        // Get the Miwok translation from the currentWord object and set this text on
        // the Miwok TextView.
        miwokTextView.setText(currentZone.getName());
